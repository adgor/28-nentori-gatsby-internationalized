...
export const Stats = () => {
  const intl = useIntl();
  return (
    <div className="relative sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
      <StaticImage
        ...
        // layout="fullWidth"
      ></StaticImage>
      <div className="absolute top-0 left-0 w-full h-full max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12 bg-opacity-90 bg-biscay-900">
        <div className="">
          <div>
